...
export class StratPokemonComponent implements OnInit {
  ...
  pokExplanation  = new Map<string, string>([
    ...
    ["Alakazam", "Alakazam est le 5éme meilleur Pokémon de sa catégorie et est un des meilleurs leads que vous puissiez avoir. En effet, sa capacité à frapper vite et fort vous permettra d'infliger de gros dégâts grâce à son attaque Psyko dès le début de la partie ou à paralyser un Pokémon avec Cage-Eclair.\n" +
